...
public class _01_Main {
	public static void main(String[] args) {
		...
		_01_GenericPrinter<_01_Powder> powderG = new _01_GenericPrinter<>();
		powderG.setMaterial(new _01_Powder());
		
		_01_Powder powder = powderG.getMaterial();
		System.out.println(powder); // powder 뒤에 .toString이 생략되있음.
		powder.doPrinting();
		
		System.out.println("\n=== T가 _01_Plastic 일 때 ===");
		
		_01_GenericPrinter<_01_Plastic> plasticG = new _01_GenericPrinter<>();
