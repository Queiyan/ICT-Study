...
public class _01_Main {
	public static void main(String[] args) {
       ...
       */
		...
		desktop.display(); // 재정의 된 자식메서드 호출(자식클래스가 new에 의해 실제 메모리공간을 차지)
		desktop.typing();  // 재정의 된 자식메서드 호출(자식클래스가 new에 의해 실제 메모리공간을 차지)
...
//		전원을 끕니다.
		...
		_01_MyNoteBook noteBook = new _01_MyNoteBook();
		noteBook.display(); // 재정의 된 자식메서드 호출(자식클래스가 new에 의해 실제 메모리공간을 차지)
		noteBook.typing();  // 재정의 된 자식메서드 호출(자식클래스가 new에 의해 실제 메모리공간을 차지)
